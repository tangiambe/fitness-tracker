...
public class ControllerService {
	...
	public void updateNutritionProperties(int trackerId, int nutritionId, int quantityToAdd, float caloriesToAdd,
			float servingSizeToAdd, LocalDate entryDate) {
	...
	public Days insertNewDay(Days day) {
		// Assuming you have access to the associated tracker, you can access it via
		// day.getTracker()
	...
	public void addNutritionTotals(int trackerId, int nutritionId, int quantityToAdd, float caloriesToAdd,
			float servingSizeToAdd, LocalDate entryDate) {
